...
<template>
    <div class="bg-white-100 min-h-screen flex flex-col">
        ...
        <!-- Header -->
        <nav class="fixed top-0 z-50 w-full bg-primary shadow-md border-b border-gray-100">
