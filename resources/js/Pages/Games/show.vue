                ...
                <div class="flex flex-col md:flex-row bg-white shadow-sm rounded-lg overflow-hidden">
                    ...
                    <div class="md:w-1/2 p-6">
                        <div class="mb-4">
                            ...
                            <p><strong>Date de parution:</strong> {{ new Date(game.published_at).toLocaleDateString() }}</p>
                            <p><strong>Stand Alone:</strong> {{ game.is_expansion ? 'Non' : 'Oui' }}</p>
                        </div>
                        <div class="mb-4">
                            <p><strong>Categories:</strong> {{ game.categories.map(c => c.name).join(', ') }}</p>
                            ...
                            <p><strong>Créateurs:</strong> {{ game.creators.map(c => c.firstname + ' ' + c.lastname).join(', ') }}</p>
                        </div>
                    </div>
                </div>
